...
var wasmImports = {
  ...
  /** @export */
  bindFramebufferInfo: _bindFramebufferInfo,
  /** @export */
  clearFBI: _clearFBI,
  /** @export */
  createFBI: _createFBI,
  /** @export */
  deleteFBI: _deleteFBI,
  /** @export */
  drawBloom: _drawBloom,
  /** @export */
  drawCameraMotionBlur: _drawCameraMotionBlur,
  /** @export */
  drawPenTile: _drawPenTile,
  /** @export */
  drawTexture: _drawTexture,
  /** @export */
  drawTextureBasic: _drawTextureBasic,
  /** @export */
...
var _SetPingpingPongpong = Module['_SetPingpingPongpong'] = createExportWrapper('SetPingpingPongpong', 1);
var _ReRender = Module['_ReRender'] = createExportWrapper('ReRender', 6);
var _SetScreenSize = Module['_SetScreenSize'] = createExportWrapper('SetScreenSize', 2);
var _zajispongpongs = Module['_zajispongpongs'] = createExportWrapper('zajispongpongs', 4);
var _DoAllTween = Module['_DoAllTween'] = createExportWrapper('DoAllTween', 0);
var _SetCurrentTime = Module['_SetCurrentTime'] = createExportWrapper('SetCurrentTime', 1);
var _AddTween = Module['_AddTween'] = createExportWrapper('AddTween', 8);
var _AddTweens = Module['_AddTweens'] = createExportWrapper('AddTweens', 9);
var _GetFloatArrayFromFloatArrayArray = Module['_GetFloatArrayFromFloatArrayArray'] = createExportWrapper('GetFloatArrayFromFloatArrayArray', 2);
var _GetComponentFields = Module['_GetComponentFields'] = createExportWrapper('GetComponentFields', 1);
var _ChangeCurrCamOption = Module['_ChangeCurrCamOption'] = createExportWrapper('ChangeCurrCamOption', 1);
var _AddDefaultCamComponents = Module['_AddDefaultCamComponents'] = createExportWrapper('AddDefaultCamComponents', 2);
var _AddCamComponents = Module['_AddCamComponents'] = createExportWrapper('AddCamComponents', 2);
var _AddCamComponent = Module['_AddCamComponent'] = createExportWrapper('AddCamComponent', 1);
var _DestroyAllCamOptions = Module['_DestroyAllCamOptions'] = createExportWrapper('DestroyAllCamOptions', 0);
var _CreateCamOption = Module['_CreateCamOption'] = createExportWrapper('CreateCamOption', 0);
var _LoadFilters = Module['_LoadFilters'] = createExportWrapper('LoadFilters', 0);
var _GetCamCount = Module['_GetCamCount'] = createExportWrapper('GetCamCount', 0);
var _SetOFFSettings = Module['_SetOFFSettings'] = createExportWrapper('SetOFFSettings', 5);
var _SetOFFSetting = Module['_SetOFFSetting'] = createExportWrapper('SetOFFSetting', 4);
var _SetONOFFs = Module['_SetONOFFs'] = createExportWrapper('SetONOFFs', 4);
var _SetONOFF = Module['_SetONOFF'] = createExportWrapper('SetONOFF', 3);
